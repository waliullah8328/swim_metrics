...
class StopWatchCalculatorScreen extends StatelessWidget {
  const StopWatchCalculatorScreen({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDottedText(
                isDark: isDark,
                title:
                "Boasts a Stopwatch mode, Predictor mode, and Course Converter mode",
              ),
              CustomDottedText(
                isDark: isDark,
                title:
                " Export your timing sheet instantly",
              ),

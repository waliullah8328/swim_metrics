...
class CourseConversionScreen extends StatelessWidget {
  const CourseConversionScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: CustomText(
          text: AppLocalizations.of(context)!.courseConversion,
          fontSize: 24.sp,
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDottedText(
                isDark: isDark,
                title:
                "Detailed split projections for converted times (SCY ↔ SCM ↔ LCM)",
              ),
              CustomDottedText(
                isDark: isDark,
                title:
              ...
              CustomDottedText(
                isDark: isDark,
                title:
                "Export conversion results with the option to show splits",
              ),

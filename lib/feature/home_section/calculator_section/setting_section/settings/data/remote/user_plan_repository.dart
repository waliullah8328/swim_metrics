...
class UserPlanRepository {
  ...
  Future<UserPlanModel> getUserPlanPackage() async {
    try {
      final endpoint = dotenv.env['USER_VIEW_YOUR_PLAN_ENDPOINT'] ?? '/user/view-your-plan/';
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        if (data is Map<String, dynamic>) {
          return UserPlanModel .fromJson(data);
        } else {

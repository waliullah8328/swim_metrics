      ...
      child: Padding(
        ...
        child: ListView(
          children: [
            ...
            ToolsHeader(isDarkMode: isDark,),
            LearningHeaderWidget(isDarkMode: isDark,),
            ...
            LegalHeaderWidget(isDarkMode: isDark,),
            ...
            Column(
              children: [
                CustomText(text: AppLocalizations.of(context)!.swimMetrics,fontSize: 18.sp,fontWeight: FontWeight.w500,),
                SizedBox(height: 10.h,),
                CustomText(text: AppLocalizations.of(context)!.version,fontSize: 14.sp,fontWeight: FontWeight.w500,color: AppColors.primary,),
                SizedBox(height: 24.h,),
                CustomText(text: AppLocalizations.of(context)!.manyThanksToMyFamilyAndFriends,fontSize: 12.sp,fontWeight: FontWeight.w400,color:isDark?Color(0xffE3D99B): Color(0xff82888E),),
                SizedBox(height: 10.h,),
                CustomText(text: AppLocalizations.of(context)!.specialThanksToMyFriends,fontSize: 12.sp,fontWeight: FontWeight.w400,color: isDark?Color(0xffE3D99B):Color(0xff82888E),textAlign: TextAlign.center,),

...
class SplitCalculatorPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SplitCalculatorPage> createState() =>
      _SplitCalculatorPageState();
}
...
class _SplitCalculatorPageState extends ConsumerState<SplitCalculatorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: CustomText(
          text: AppLocalizations.of(context)!.splitCalculator,
                                        ...
                                        Consumer(
                                          builder: (context, ref, child) {
                                            ...
                                            final current = state.gender
                                                .toLowerCase();
                                            final isValid = rawItems.contains(
                                              current,
                                            );
                                            final safeGender = isValid
                                                ? current
                                                : rawItems.first;
                                      ...
                                      children: [
                                        ...
                                        Consumer(
                                          builder: (context, ref, child) {
                                            ...
                                            /// ✅ VALIDATE STATE
                                            final current = state.stroke
                                                .toLowerCase();
                                            final isValid = availableStrokes
                                                .contains(current);
                                            final safeStroke = isValid
                                                ? current
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            ref
                                .watch(splitCalcProvider.notifier)
                                .clearHistory();
                          },
                          child: Center(
                            child: Row(

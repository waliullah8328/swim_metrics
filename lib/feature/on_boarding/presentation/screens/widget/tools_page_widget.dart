...
class ToolsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(  // ✅ prevents overflow on small screens
      physics: const NeverScrollableScrollPhysics(), // ✅ keeps parent page swipe working
      child: Padding(
        padding: EdgeInsets.only(left: 20.w, right: 20.w, top: 40.h), // ✅ slightly reduced top padding
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            CustomText(
              text: AppLocalizations.of(context)!.theCoreTools,
              fontSize: 22.sp,
            ...
            CoreToolCard(
              ...
              description: AppLocalizations.of(context)!.calculateTargetSplitsFor,
            ...
            CoreToolCard(
              ...
              description: AppLocalizations.of(context)!.seamlesslyConvertTimesBetweenSCY,
              icon: IconPath.conversionIcon,
              onTap: () {},
            ),
            CoreToolCard(
              title: AppLocalizations.of(context)!.stopWatch,
              description: AppLocalizations.of(context)!.timeSwimsWithPrecision,

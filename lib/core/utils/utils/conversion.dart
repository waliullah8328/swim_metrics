class ConversionCore {
  ...
  static final Map<String, dynamic> baseTimes = {
    'men': {
      ...
      'fly': {
        '50': {'scy': 18.78, 'scm': 21.51, 'lcm': 22.80},
      ...
      'breast': {
        '50': {'scy': 22.75, 'scm': 25.52, 'lcm': 26.57},
    ...
    'women': {
      ...
      'fly': {
        '50': {'scy': 20.63, 'scm': 23.72, 'lcm': 25.18},
  ...
  static double? wrMultiplier(String gender, String stroke, String distance, String from, String to) {
    ...
    if (from == 'scy' && to == 'scm') {
      final a = (s[distance] as Map?)?[from];
      final b = (s[distance] as Map?)?[to];
      if (a is num && b is num) return b / a;
    }
    if (from == 'scy' && to == 'lcm') {
      final a = (s[distance] as Map?)?[from];
      final b = (s[distance] as Map?)?[to];
